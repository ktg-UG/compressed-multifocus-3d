...
class HQSTrainer(Trainer):
    def __init__(self, img_model, input_imgs, device, gt_slices=None, version=None, denoiser_weights=None,
                 noise_level=0.0, output_dir="outputs", save_interval=None, image_format="png",
                 auto_upload=False, gdrive_base="gdrive:multifocus-3d-reconstruction", **kwargs):
    ...
    def train(self):
        ...
        self.save_results(alpha, out, prefix="hqs_final")
