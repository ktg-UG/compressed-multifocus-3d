...
class NFTrainer(Trainer):
    def __init__(self, img_model, input_imgs, device, gt_slices=None, version=None, weights=None, output_dir="outputs",
                 save_interval=None, image_format="png", auto_upload=False,
                 gdrive_base="gdrive:multifocus-3d-reconstruction", **kwargs):
    ...
    def train(self):
        ...
        self.save_results(alpha, out, prefix="nf_final")
